...
static const int64_t nTargetTimespan = 20 * 60;  // 20m
...
int CMerkleTx::GetBlocksToMaturity() const
{
    if (!(IsCoinBase() || IsCoinStake()))
        return 0;
    return max(0, (nCoinbaseMaturity+60) - GetDepthInMainChain());
}
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    int64_t nSubsidy = nCoinAge * nRewardCoinYear / 365 / COIN;
        ...
        if(pindexBest->nHeight < 149000)
    {
        nSubsidy = nCoinAge * nRewardCoinYear / 365 / COIN;
    }
        else if(pindexBest->nHeight < 173500)
    {
        nSubsidy = 10 * COIN;
    }
        else if(pindexBest->nHeight < 174500)
    {
        nSubsidy = 100 * COIN;
    }
        else if(pindexBest->nHeight < 199000)
    {
        nSubsidy = 10 * COIN;
    }
        else if(pindexBest->nHeight < 200000)
    {
        ...
        else if(pindexBest->nHeight < 224500)
    {
        nSubsidy = 10 * COIN;
    }    
        else if(pindexBest->nHeight < 225500)
    {
        nSubsidy = 100 * COIN;
    } 
        ...
        else if(pindexBest->nHeight < 251000)
    {
        ...
        else if(pindexBest->nHeight < 275500)
    {
        nSubsidy = 5 * COIN;
    }
        else if(pindexBest->nHeight < 276500)
    {
        nSubsidy = 100 * COIN;
    } 
        else if(pindexBest->nHeight < 301000)
    {
        nSubsidy = 5 * COIN;
    }
        else if(pindexBest->nHeight < 302000)
    {
        nSubsidy = 100 * COIN;
    } 
        else if(pindexBest->nHeight < 326500)
    {
        nSubsidy = 5 * COIN;
    }
        else if(pindexBest->nHeight < 327500)
    {
        nSubsidy = 100 * COIN;
    } 
        else if(pindexBest->nHeight < 352000)
    {
        ...
        else if(pindexBest->nHeight < 353000)
    {
        nSubsidy = 100 * COIN;
    }
        else if(pindexBest->nHeight < 377500)
    {
        nSubsidy = 2.5 * COIN;
    }
        else if(pindexBest->nHeight < 378500)
    {
        nSubsidy = 100 * COIN;
    }
        else if(pindexBest->nHeight < 403000)
    {
        nSubsidy = 2.5 * COIN;
    }
        else if(pindexBest->nHeight < 404000)
    {
        nSubsidy = 100 * COIN;
    }  
        else if(pindexBest->nHeight < 428500)
    {
        nSubsidy = 2.5 * COIN;
    }
        else if(pindexBest->nHeight < 429500)
    {
        nSubsidy = 100 * COIN;
    }  
        else if(pindexBest->nHeight < 454000)
    {
        nSubsidy = 2.5 * COIN;
    }
        else if(pindexBest->nHeight < 455000)
    {
        nSubsidy = 100 * COIN;
    }
        else if(pindexBest->nHeight < 479500)
    {
        nSubsidy = 1 * COIN;
    }
        else if(pindexBest->nHeight < 480500)
    {
        nSubsidy = 100 * COIN;
    } 
        else if(pindexBest->nHeight < 505000)
    {
        nSubsidy = 1 * COIN;
    }
        else if(pindexBest->nHeight < 506000)
    {
        nSubsidy = 100 * COIN;
    } 
        else if(pindexBest->nHeight < 530500)
    {
        nSubsidy = 1 * COIN;
    }
        else if(pindexBest->nHeight < 531500)
    {
        nSubsidy = 100 * COIN;
    } 
        else if(pindexBest->nHeight < 556000)
    {
        nSubsidy = 1 * COIN;
    }
        else if(pindexBest->nHeight < 557001)
    {
        nSubsidy = 100 * COIN;
    }           
        else if(pindexBest->nHeight > 557000)
    {
        nSubsidy = 0 * COIN;
    }    
